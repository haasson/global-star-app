<template>
   <AppPage :topOffset="false" :bottomOffset="width > 992" class="main-page">
      ...
      <div :class="{'orange-block': width <= 992}">
         ...
         >
            <p>
              Мы предлагаем программные решения, которые позволяют нашим клиентам контролировать производительность своего автопарка, снижают затраты на его эксплуатацию, позволяют улучшить анализ внутренних процессов предприятия и вывести его на лучший уровень эффективности.
            </p>
         </TextWithImage>
      </div>
   </AppPage>
